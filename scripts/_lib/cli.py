"""scripts/_lib/cli.py — shared scaffolding for the `telemachus-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("telemachus-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/telemachus-foo`
...
VERSION = "0.1.0"  # bumped centrally; every telemachus-* CLI reports this
