...
def build_dataset() -> list[dict]:
    ...
    add("INBOX", "", _msg(
        ...
        text=("Hey,\n\nSaw your work on the Telemachus stack — seriously impressive. "
        ...
        html=("<p>Hey,</p><p>Saw your work on the <b>Telemachus</b> stack — seriously "
...
def _seed_cache() -> None:
    ...
    reply = (
        ...
        "— drafted for you by your Telemachus assistant"
    )
...
def main() -> int:
    ...
    try:
        ...
        print(f"seeded {len(items)} demo message(s) into {USER} "
              f"(INBOX + Sent). Switch to the 'Demo' account in Telemachus to view.")
        return 0
    finally:
        try:
            conn.logout()
